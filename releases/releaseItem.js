function linksGenerator() {
	function anchor(displayName, linkName, variant) {
		...
		anchorTag.href = `https://sourceforge.net/projects/electro-sweet/files/${variant}/ElectroKernel-${linkName}-Stable-sweet-?.zip/download`;
		return anchorTag;
	}
	const linkSpan = document.createElement('span');
	linkSpan.append(
		anchor('MIUI', 'Miui', 'miui'),
		anchor('OSS', 'OSS', 'oss'),
		anchor('MIUI-KSU', 'KernelSU-Miui', 'miui-su'),
		anchor('OSS-KSU', 'KernelSU-OSS', 'oss-su')
	);
	return linkSpan;
}
